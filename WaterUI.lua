...
do 
    ...
    do
        ...
        local window = {} do 
            ...
            window.size = UDim2.fromOffset(isMobile and 320 or 450, isMobile and 400 or 350) -- current win size
            ...
            local instances = {} do 
                ...
                mainFrame.Size = UDim2.fromOffset(isMobile and 320 or 500, isMobile and 400 or 350)
        ...
        local pickerWindow = {} do 
            ...
            pickerWindow.new = function(self, resize) 
                ...
                do 
                    ...
                    titleBar.InputBegan:Connect(function(io) 
    if (io.UserInputType.Value == 0 or io.UserInputType == Enum.UserInputType.Touch) then
        local rootPos = mainFrame.AbsolutePosition
        local startPos = io.Position
        ...
        dCon = inputService.InputChanged:Connect(function(io) 
            if (io.UserInputType.Value == 4 or io.UserInputType == Enum.UserInputType.Touch) then
                local curPos = io.Position
                curPos = Vector2.new(curPos.X, curPos.Y) 
    ...
    ui.newWindow = function(settings) 
        ...
        local s_position = settings.position
             if (not s_position) then
                s_position = UDim2.fromScale(0.5, 0.5)
        end
