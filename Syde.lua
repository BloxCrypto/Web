...
MobileButton.BackgroundColor3 = syde.theme.Accent
...
mobileStroke.Color = syde.theme.Accent
...
-- Animate mobile button on hover
MobileButton.MouseEnter:Connect(function()
	tweenservice:Create(MobileButton, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {BackgroundTransparency = 0}):Play()
	tweenservice:Create(MobileButton, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 55, 0, 55)}):Play()
	tweenservice:Create(mobileStroke, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {Transparency = 0}):Play()
end)

MobileButton.MouseLeave:Connect(function()
	tweenservice:Create(MobileButton, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {BackgroundTransparency = 0.1}):Play()
	tweenservice:Create(MobileButton, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 50, 0, 50)}):Play()
	tweenservice:Create(mobileStroke, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {Transparency = 0.5}):Play()
end)

-- Update mobile button color when theme changes
syde:AddConnection(syde.Comms.Event, function(p, color)
	if p == 'Accent' then
		tweenservice:Create(MobileButton, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {BackgroundColor3 = color}):Play()
		tweenservice:Create(mobileStroke, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Color = color}):Play()
	end
end)
